    ...
    if (newColor && newColor.hex && elementId) {
      setCustomizerData((prevData) => ({
        ...
        SwitchViewDots: {
          ...
          [elementId === "SwitchViewDotsClr"
            ? "colour"
            : elementId === "SwitchViewDotsSelectClr"
            ? "SelectColour"
            : ""]: newColor.hex,
        },
      }));
  ...
  return (
    <>
            ...
            <div className="deom_color">
              <div className="example full">
                <div className="clr-field">
                  <input
                    type="hidden"
                    value={customizerData.SwitchViewDots.colour}
                  />
                  <span
                    data-element="SwitchViewDotsClr"
                    onClick={(e) => {
                      handleColorPickerClick(e);
                      handleColorChange(
                        { hex: customizerData.SwitchViewDots.colour },
                        "SwitchViewDotsClr"
                      );
                    }}
                    style={{
                      ...
                      backgroundColor: customizerData.SwitchViewDots.colour,
                    }}
                  ></span>
                </div>
              </div>
      ...
      <div className="right_wrapper_row rowClrPicker">
        {showPicker && showElement === "SwitchViewDotsClr" && (
          <div
            ref={colorPickerRef}
          ...
          >
            <ChromePicker
              color={{ hex: customizerData.SwitchViewDots.colour }}
              onChange={(color) =>
                handleColorChange(color, "SwitchViewDotsClr")
              }
            />
          </div>
        )}
            ...
            <div className="deom_color">
              <div className="example full">
                <div className="clr-field">
                  <input
                    type="hidden"
                    value={customizerData.SwitchViewDots.SelectColour}
                  />
                  <span
                    data-element="SwitchViewDotsSelectClr"
                    onClick={(e) => {
                      handleColorPickerClick(e);
                      handleColorChange(
                        { hex: customizerData.SwitchViewDots.SelectColour },
                        "SwitchViewDotsSelectClr"
                      );
                    }}
                    style={{
                      display: "inline-block",
                      ...
                      height: "30px",
                      border: "2px solid #000",
                      backgroundColor: customizerData.SwitchViewDots.SelectColour,
                    }}
                  ></span>
                </div>
              </div>
      ...
      <div className="right_wrapper_row rowClrPicker">
        {showPicker && showElement === "SwitchViewDotsSelectClr" && (
          <div
            ref={colorPickerRef}
            onClick={(e) => e.stopPropagation()}
            style={{ position: "absolute", zIndex: 2 }}
          >
            <ChromePicker
              color={{ hex: customizerData.SwitchViewDots.SelectColour }}
              onChange={(color) =>
                handleColorChange(color, "SwitchViewDotsSelectClr")
              }
            />
          </div>
        )}
