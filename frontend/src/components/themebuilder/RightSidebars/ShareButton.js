            ...
            <div className="switch_button_row">
              <label className="printing_methods_switch_button">
                <input
                  type="checkbox"
                  checked={
                    customizerData.ShareButton.ShareButtonDisplayButtonYN ===
                    "true"
                  }
                  onChange={(e) =>
                    handleInputChange({
                      name: "ShareButtonDisplayButtonYN",
        ...
        <div className="right_wrapper_col">
          ...
          <div className="right_property_value">
            <label className="theme_check_button">
              <input
                type="radio"
                value={customizerData?.ShareButton?.ShareButtonIconButton}
                checked={
                  customizerData.ShareButton.ShareButtonIconButton === "true"
                }
                onChange={(e) =>
                  handleInputChange({
                    name: "ShareButtonIconButton",
                    value: e.target.checked ? "true" : "false",
                  })
                }
              />
          ...
          <div className="right_property_value">
            <label className="theme_check_button">
              <input
                ...
                value={customizerData?.ShareButton?.ShareButtonIconButton}
                checked={
                  customizerData.ShareButton.ShareButtonIconButton === "false"
                }
                onChange={(e) =>
                  handleInputChange({
                    name: "ShareButtonIconButton",
