...
const OutOfStock = () => {
  ...
  return (
    <>
          ...
          <div className="right_property_value">
            <div className="deom_color">
              <div className="example full">
                <div className="clr-field">
                  <span
                    data-element="OutOfStockBadgeBannerTextColor"
                    onClick={(e) =>
                      handleColorPickerClick(
                        e,
                        "OutOfStockBadgeBannerTextColor"
                      )
                    }
                    style={{
                      display: "inline-block",
      ...
      <div className="right_wrapper_row rowClrPicker">
        {showPicker && showElement === "OutOfStockBadgeBannerTextColor" && (
          <div
            ref={colorPickerRef}
            onClick={(e) => e.stopPropagation()}
            style={{ position: "absolute", zIndex: 2 }}
          >
            <ChromePicker
              ...
              onChange={(color) =>
                handleColorChange(color, "OutOfStockBadgeBannerTextColor")
              }
            />
          </div>
        )}
          ...
          <div className="right_property_value">
            <div className="deom_color">
              <div className="example full">
                <div className="clr-field">
                  <span
                    data-element="OutOfStockBadgeBannerBkgColor"
                    onClick={(e) =>
                      handleColorPickerClick(e, "OutOfStockBadgeBannerBkgColor")
                    }
                    style={{
                      display: "inline-block",
                      width: "30px",
      ...
      <div className="right_wrapper_row rowClrPicker">
        {showPicker && showElement === "OutOfStockBadgeBannerBkgColor" && (
          <div
            ref={colorPickerRef}
            onClick={(e) => e.stopPropagation()}
            style={{ position: "absolute", zIndex: 2 }}
          >
            <ChromePicker
              ...
              onChange={(color) =>
                handleColorChange(color, "OutOfStockBadgeBannerBkgColor")
              }
            />
          </div>
        )}
