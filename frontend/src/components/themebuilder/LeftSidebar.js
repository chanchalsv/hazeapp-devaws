    ...
    <div className="sider_baar">
      <div className="sidebar_menu_section">
        <ul className="sidebar_menu">
          ...
          >
            <a href="#" onClick={() => handleAnchorClick("Layers_Panel_list")}>
              <span className="sidebar_menu_icon">
          ...
          >
            <a href="#" onClick={() => handleAnchorClick("Layers_list")}>
              <span className="sidebar_menu_icon">
          ...
          >
            <a href="#" onClick={() => handleAnchorClick("File_Upload_list")}>
              <span className="sidebar_menu_icon">
                <span className="sidebar_menu_icon">
          ...
          >
            <a href="#" onClick={() => handleAnchorClick("Print_Ready_list")}>
              <span className="sidebar_menu_icon">
                <span className="sidebar_menu_icon">
          ...
          >
            <a href="#" onClick={() => handleAnchorClick("Customizer_list")}>
              <span className="sidebar_menu_icon">
                <span className="sidebar_menu_icon">
          ...
          >
            <a href="#" onClick={() => handleAnchorClick("Step_Title_list")}>
              <span className="sidebar_menu_icon">
                <span className="sidebar_menu_icon">
                  <img src="assets/Image/them/text.svg" />
                </span>
          ...
          >
            <a href="#" onClick={() => handleAnchorClick("Summary_Title_list")}>
              <span className="sidebar_menu_icon">
                <span className="sidebar_menu_icon">
                  <img src="assets/Image/them/text.svg" />
                </span>
          ...
          >
            <a href="#" onClick={() => handleAnchorClick("Cart_button_list")}>
              <span className="sidebar_menu_icon">
                <span className="sidebar_menu_icon">
          ...
          >
            <a href="#" onClick={() => handleAnchorClick("Price_list")}>
              <span className="sidebar_menu_icon">
                <span className="sidebar_menu_icon">
          ...
          >
            <a href="#" onClick={() => handleAnchorClick("Zoom_list")}>
              <span className="sidebar_menu_icon">
                <span className="sidebar_menu_icon">
          ...
          >
            <a href="#" onClick={() => handleAnchorClick("Share_Button_list")}>
              <span className="sidebar_menu_icon">
                <span className="sidebar_menu_icon">
          ...
          <li
            className={`sidebar_list ${
              activeLink === "Description_list" ? "sidebar_active_list" : ""
            }`}
          >
            <a href="#" onClick={() => handleAnchorClick("Description_list")}>
              <span className="sidebar_menu_icon">
                <span className="sidebar_menu_icon">
          ...
          >
            <a href="#" onClick={() => handleAnchorClick("Out_of_Stock_list")}>
              <span className="sidebar_menu_icon">
                <span className="sidebar_menu_icon">
